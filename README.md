...
pixi add rabbitmq-server
# for installing globally
pixi global install rabbitmq-server
```
...
It is possible to list all of the versions of `rabbitmq-server` available on your platform:
...
```
pixi search rabbitmq-server --channel conda-forge
```
